/*
 * Archivo: T_FRONTFSTIYXEX_288.java
 * Fecha: 2021-04-22T20:56:36Z
 *
 ...
 * T_FRONTFSTIYXEX_288 - EstudianteJesForm 
 *
 */
@Path("/FRONT/ENDDD/T_FRONTFSTIYXEX_288")
@Component
@Service({T_FRONTFSTIYXEX_288.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=FRONT)(task.submodule=ENDDD)(task.id=T_FRONTFSTIYXEX_288)(task.version=1.0.0))")
,@Reference(name="VW_ESTUDIANES_748", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_ESTUDIANES_748)(view.version=1.0.0))")
...
public class T_FRONTFSTIYXEX_288 {
