/*
 * Archivo: T_FRONTHDPRWEIY_200.java
 * Fecha: 2021-04-22T20:56:37Z
 *
 ...
 * T_FRONTHDPRWEIY_200 - EstudianteBDFForm 
 *
 */
@Path("/FRONT/ENDDD/T_FRONTHDPRWEIY_200")
@Component
@Service({T_FRONTHDPRWEIY_200.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=FRONT)(task.submodule=ENDDD)(task.id=T_FRONTHDPRWEIY_200)(task.version=1.0.0))")
,@Reference(name="VW_ESTUDIANTT_152", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_ESTUDIANTT_152)(view.version=1.0.0))")
...
public class T_FRONTHDPRWEIY_200 {
