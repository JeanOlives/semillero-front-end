/*
 * Archivo: T_FRONTNUITXMNA_708.java
 * Fecha: 2021-04-22T20:56:34Z
 *
 ...
 * T_FRONTNUITXMNA_708 - EstudianteLampForm 
 *
 */
@Path("/FRONT/ENDDD/T_FRONTNUITXMNA_708")
@Component
@Service({T_FRONTNUITXMNA_708.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=FRONT)(task.submodule=ENDDD)(task.id=T_FRONTNUITXMNA_708)(task.version=1.0.0))")
,@Reference(name="VW_ESTUDIANEE_309", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_ESTUDIANEE_309)(view.version=1.0.0))")
...
public class T_FRONTNUITXMNA_708 {
