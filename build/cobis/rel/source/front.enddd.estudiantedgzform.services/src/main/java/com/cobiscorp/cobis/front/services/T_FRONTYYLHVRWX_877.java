/*
 * Archivo: T_FRONTYYLHVRWX_877.java
 * Fecha: 2021-04-22T20:56:35Z
 *
 ...
 * T_FRONTYYLHVRWX_877 - EstudianteDGZForm 
 *
 */
@Path("/FRONT/ENDDD/T_FRONTYYLHVRWX_877")
@Component
@Service({T_FRONTYYLHVRWX_877.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=FRONT)(task.submodule=ENDDD)(task.id=T_FRONTYYLHVRWX_877)(task.version=1.0.0))")
,@Reference(name="VW_ESTUDIANED_572", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_ESTUDIANED_572)(view.version=1.0.0))")
...
public class T_FRONTYYLHVRWX_877 {
