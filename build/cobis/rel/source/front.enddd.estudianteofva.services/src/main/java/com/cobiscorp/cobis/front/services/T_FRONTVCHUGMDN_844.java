/*
 * Archivo: T_FRONTVCHUGMDN_844.java
 * Fecha: 2021-04-22T20:56:01Z
 *
 ...
 * T_FRONTVCHUGMDN_844 - EstudianteOFVA 
 *
 */
@Path("/FRONT/ENDDD/T_FRONTVCHUGMDN_844")
@Component
@Service({T_FRONTVCHUGMDN_844.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=FRONT)(task.submodule=ENDDD)(task.id=T_FRONTVCHUGMDN_844)(task.version=1.0.0))")
,@Reference(name="VW_ESTUDIANAO_277", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_ESTUDIANAO_277)(view.version=1.0.0))")
...
public class T_FRONTVCHUGMDN_844 {
